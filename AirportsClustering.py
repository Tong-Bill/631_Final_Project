...
# R9 Prompt: Analysis of Airline data. You can come up with your own ideas of analyzing the Airline data using machine learning algorithms. The data is stored here: https://openflights.org/data.php. For example, use clustering algorithms to identify patterns.
# Retrieved picture: https://ggos.org/item/dem-digital-elevation-model/
# What airport is similar to my input airport?
...
# Elevation Trends
# Is elevation a major separator? one cluster might contain mostly mountain, sea-level, ground-level airports
